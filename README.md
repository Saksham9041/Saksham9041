...
<p align="center">
<a href="https://github.com/Saksham9041/Saksham9041/blob/main/Saksham_Resume_Final.pdf">📄 View My Resume</a> &nbsp;|&nbsp;
...
- Anomaly Detection & Class Imbalance Handling (SMOTE)
...
- Multi-hop reasoning & explainable retrieval
...
**[Supply Chain Analytics & Vendor Optimization Dashboard](https://github.com/Saksham9041/Supply-Chain-Performance-Dashboard)**
...
Real-time analytics dashboard with a SQLite-backed pipeline and scikit-learn forecasting models, including a live What-If simulator.
...
**Credit Card Fraud Detection Using Machine Learning** — *IEEE Xplore, Published*
ML-driven fraud detection using XGBoost, Random Forest, and anomaly detection with SMOTE for class imbalance.

**Graph-RAG for Legal Contract Analysis** — *Computer Science Journal, Scopus-Indexed*
Graph-RAG pipeline (Neo4j, FAISS, LangChain, Gemini LLM) benchmarked on the CUAD dataset — Precision@5 of 0.76, Recall@5 of 0.88.
